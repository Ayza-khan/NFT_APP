        ...
        <Container >
            ...
            <Accordion defaultActiveKey="0" flush className="py-5">
                ...
                <Accordion.Item eventKey="4">
                    ...
                    <Accordion.Body>
                    1. Our Collection are unique because, It is not a copy of any other digital asset, instead is an outcome of my request mixed with the creativity of a Marketer, a Publicist and 2 different designers whom have never seen each other, lives in different countries/continents and have a completely different approach. <nr/>
